...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "Submission Verifier — evidence-backed hackathon review" },
      {
        name: "description",
        content:
      ...
      {
        property: "og:title",
        content: "Submission Verifier — evidence-backed hackathon review",
      },
      {
      ...
      {hackathons.length === 0 ? (
        <div className="mt-16 text-center">
          ...
          <p className="mx-auto mt-1 max-w-sm text-sm text-muted-foreground">
            Create one, upload the submission sheet, and the analysis starts
            from there.
          </p>
